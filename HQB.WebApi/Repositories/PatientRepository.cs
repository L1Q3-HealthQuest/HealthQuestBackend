...
public class PatientRepository : IPatientRepository
{
    ...
    {
        using var connection = new SqlConnection(_connectionString);
        string sqlQuery = "SELECT * FROM Patient WHERE DoctorID = @DoctorId";
    ...
    {
        using var connection = new SqlConnection(_connectionString);
        string sqlQuery = "SELECT * FROM Patient WHERE GuardianID = @GuardianId";
    ...
    {
        using var connection = new SqlConnection(_connectionString);
        string sqlQuery = "UPDATE Patient SET FirstName = @FirstName, LastName = @LastName, GuardianID = @GuardianID, TreatmentID = @TreatmentID, DoctorID = @DoctorID, Avatar = @Avatar WHERE ID = @Id";
        return await connection.ExecuteAsync(sqlQuery, patient);
    }
