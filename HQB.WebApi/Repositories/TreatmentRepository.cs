...
public class TreatmentRepository : ITreatmentRepository
{
    ...
    {
        using var connection = new SqlConnection(_connectionString);
        const string sql = "SELECT * FROM Treatment WHERE ID = @ID";
    ...
    {
        using var connection = new SqlConnection(_connectionString);
        const string sql = "INSERT INTO Treatment (ID, Name) VALUES (@ID, @Name)";
    ...
    {
        using var connection = new SqlConnection(_connectionString);
        const string sql = "UPDATE Treatment SET Name = @Name WHERE ID = @ID";
        return await connection.ExecuteAsync(sql, treatment);
    }
    ...
    {
        using var connection = new SqlConnection(_connectionString);
        const string sql = "DELETE FROM Treatment WHERE ID = @ID";
