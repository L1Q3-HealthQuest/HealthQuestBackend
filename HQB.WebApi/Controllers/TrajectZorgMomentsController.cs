...
namespace HQB.WebApi.Controllers
{
    ...
    [ApiController]
    public class TrajectZorgMomentsController : ControllerBase
    {
        private readonly ZorgAppDbContext _context;

        public TrajectZorgMomentsController(ZorgAppDbContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<TrajectZorgMoment>> GetTrajectZorgMoment(Guid id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutTrajectZorgMoment(Guid id, TrajectZorgMoment trajectZorgMoment)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteTrajectZorgMoment(Guid id)
        {
            var trajectZorgMoment = await _context.TrajectZorgMomenten.FindAsync(id);
            if (trajectZorgMoment == null)
            {
        ...
        private bool TrajectZorgMomentExists(Guid id)
        {
