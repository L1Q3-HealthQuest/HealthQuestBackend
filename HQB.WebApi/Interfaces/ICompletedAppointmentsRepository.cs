...
public interface ICompletedAppointmentsRepository
{
  ...
  Task<Appointment?> GetCompletedAppointmentByIdAsync(Guid id);
  ...
  Task AddCompletedAppointmentAsync(Appointment appointment);
  ...
  /// <returns>A task that represents the asynchronous operation.</returns>
  Task UpdateCompletedAppointmentAsync(Appointment appointment);
